...
async def main():
    parser = argparse.ArgumentParser(description='process a powerpoint (.pptx) file and summarize its content using chatgpt')
    parser.add_argument('input_pptx', type=str, nargs='?', default='Corona.pptx', help='path to the powerpoint file (.pptx) default is: Corona.pptx')
